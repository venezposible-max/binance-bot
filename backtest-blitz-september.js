...
async function runBacktest() {
    ...
    // September 2025: From 2025-09-01 00:00:00 to 2025-09-30 23:59:59
    const startTime = new Date('2025-09-01T00:00:00Z').getTime();
    const endTime = new Date('2025-09-30T23:59:59Z').getTime();

    console.log(`🚀 STARTING SEPTEMBER 2025 BLITZ BACKTEST (NO SL, MAX ${MAX_TRADES} TRADES)`);
    console.log(`-----------------------------------------------------------------------`);
    ...
    console.log(`-----------------------------------------------------------------------`);
    console.log(`RESULTADOS POR MONEDA (SEPTIEMBRE 2025):`);
    symbols.forEach(s => {
